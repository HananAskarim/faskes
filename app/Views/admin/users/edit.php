...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <br />
        <form action="<?= base_url('/admin/users/update/' . $users->id_user); ?>" method="post" data-parsley-validate class="form-horizontal form-label-left">
            <?= csrf_field(); ?>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="username" name="username" class="form-control " value="<?= $users->username; ?>" autofocus>
                </div>
            </div>
            <div class="item form-group">
