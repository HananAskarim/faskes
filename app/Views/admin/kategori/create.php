...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <br />
        <form action="<?= base_url('/admin/kategori/save'); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
            <?= csrf_field(); ?>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="nama_kategori" name="nama_kategori" class="form-control " value="<?= old('nama_kategori'); ?>" autofocus>
                </div>
            </div>
            <div class="item form-group">
