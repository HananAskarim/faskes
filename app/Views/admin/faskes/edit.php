...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <br />
        <form action="<?= base_url("/admin/faskes/update/$faskes->id_faskes"); ?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
            <?= csrf_field(); ?>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="nama_faskes" name="nama_faskes" class="form-control " value="<?= $faskes->nama_faskes; ?>" autofocus>
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <select name="id_kategori" id="id_kategori" class="form-control">
                        ...
                        ?>
                            <option value="<?= $row->id_kategori; ?>" <?= ($row->id_kategori == $faskes->id_kategori ? 'selected' : ''); ?>> <?= $row->nama_kategori; ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="telp" name="telp" class="form-control " value="<?= $faskes->telp; ?>">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="layanan" name="layanan" class="form-control " value="<?= $faskes->layanan; ?>">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="latitude" name="latitude" class="form-control " value="<?= $faskes->latitude; ?>">
                </div>
            </div>
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="longitude" name="longitude" class="form-control " value="<?= $faskes->longitude; ?>">
                </div>
            </div>
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                    <img src="<?= base_url("assets/uploads/faskes/$faskes->foto"); ?>" class="rounded" width="150px">
                </div>
            </div>
